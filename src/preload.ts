...
const api: EdvidDesktopApi = {
  ...
  suggestSplitPrompt: (directory, index, kind) => ipcRenderer.invoke('preview:suggest-split-prompt', { directory, index, kind }),
  generateAtMark: (directory, start, end, kind, prompt, destino) => ipcRenderer.invoke('preview:generate-at-mark', { directory, start, end, kind, prompt, destino }),
  attachAtMark: (directory, start, end, destino) => ipcRenderer.invoke('preview:attach-at-mark', { directory, start, end, destino }),
  suggestMarkPrompt: (directory, start, end, kind) => ipcRenderer.invoke('preview:suggest-mark-prompt', { directory, start, end, kind }),
